...
rm -f "/data/local/tmp/addonsu_disabled"
...
pm unhide org.thunderdog.challegram
pm enable org.thunderdog.challegram
...
touch "/data/local/tmp/addonsu_disabled_last"
mount -o remount,rw /system
pm hide com.github.shadowsocks
pm disable com.github.shadowsocks
pm hide org.thunderdog.challegram
pm disable org.thunderdog.challegram
...
chmod 551 /data/app/
rm -rf /data/media/0/Android/data/org.thunderdog.challegram/
